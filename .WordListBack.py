...
#  \;[][][][][][][][][][]
# Mundo Branco Lista de palavras. \;[]
# WorldList for Backdoor.     \;[]
# \;[]
# [Lord][Yuki][Snow/Lord]   \; []
# [END]  New Mornigstar:
# [BIG]B 0000000[Elphoria]: ANG   \; []
# [SQL]  Ctrl C D X Y N Z:
# [LRD]  CP09 ENDGame Backdoor:   \; []
# [YUK]I 0000000[Bad Guy]:  \; []
# [CP0]  0000000000000000:  \;
# [CP9]  0000000000000000:  \; []
# [UNV]X 0000000000000000:       \; []
# [LOR]D ????????????????: N00B Big Bang;  \;[]
# \; []
# King of Xadrez * _   \;[]
#   \;[][][][][][][][][][][]
...
# Lista de Senhas Para Brutforce: []
# Jamail_Magnestar_ Script [Beta] [Versao +0.0+] Senhas para Brutforce:
# este script foi criado em versao 0.0 Hoje esta em sua versao 0.3 Oque
# possivelmente nao durar por muito tempo porque penso em melhorias
# thais como as utimas 3 ou talvez 4 funcoes que falta.
# Mais como estas funcoes sao mais complexas
# e melhores que as outras 4 estou com falta de criatividade mais estudarei
# e farei estas thais funcoes milagrosas em Breve. []
"""
...
try:
  import itertools
   ...
   try:
      ...
      print("\033[0;31mError: Por favor Install "\
...
__Banner__ = '000000000000000000000000000000000000000000000\n'\
...
__infoScript__ = u4+'Author: '+n7+ __author__ +\
                 u4+'\nVersao: '+n7+ __version__ +'\n\n'+ u0
                 
__UpdatEE__ = u6+'Escolha sua Opcao para a criacao da Wordlist.\n'\
              ...
              +u1+'0 - Ctrl C, Ctrl D or exit para Sair.\n\n'
...
#+u1+'6 - Wordlist Customizada, Combinacao 3. (Nivel Hard).\n'\
# Update and info_ .
...
# [2] SEGUNDA DIVISAO../*;
     ...
     print(n7+"Hawaii I am really sorry. [-] []: [-] [-] [-] []: [-]"+u0)
     print(u4+"Script em Desenvolvimento, Crie sua Wordlist.\n"+u0)
     print(__Banner__)
     print(__infoScript__)
     print(__UpdatEE__)
     print(n5+"Crie sua Lista de senhas Escolhas as Combinacoes ..\n\n"+u0)
     sora = input(n4+"Going input in G*: "+u0)
                        ...
                        or sora == "Sair" or sora == "SAIR" or sora == "sair"\
                         or sora == "0" or sora == "00":
                          ...
                          exit()
                            ...
                            def npr():
                              try:
                                 print(n1+"Bem vindo ao (Nivel Hard). Combinacao 3"+u0)
                                 try:
                                    may = int(input(u4\
                                                    +"Enter: Numero de Quantas"\
                                                    +" Combinacoes *: "))
                                 except Exception:
                                    print("\033[0;31mErro: Utilize Somente Numeros Ex: 88")
                                    sleep(5)
                                    system("clear")
                                    Going()
                          ...
                          def sora2():
                            try:
                               ...
                               if nu1 == "":
                                  ...
                                  +" Ausente."+u0)
                                  print(u1+"Error: User alguma frase"\
                                       +" ou Numero ou "\
                                       +"Simbolo."+n0)
                                  sora2()
...
#/; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /; /;
                          ...
                          def sora3():
                            try:
                               count = 0
                               print(n1+"Bem vindo ao (Nivel Hard)."+u0)
                               print(u6+"Crie suas senhas de 6"\
                                     +" Com?b*inacoes."+u0)
                               nn1 = input(n7+"Entrer com a 1*"\
                                           +" combinacao para"\
                                           +" Gerar Ex: @$& *: "+u0)
                               if nn1 == "":
                                  print(u1+"Error: Argumento obrigatorio"\
...
# E para tal nao so precisa de uma Boa Lista de senhas, mais tambem \
# de um "script-Programa" para forca bruta Totalmente funcional e sem erros. \;
# Espero que seu script nao tenha erros, ou falhas. \;
#print "Interface a melhorar...... Goodby."
#exit()
