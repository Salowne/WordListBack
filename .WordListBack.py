...
__banner__ = n7+'000000000000000000000000000000000000000000000\n'\
...
__updateEE__ = u6+'Escolha sua opcao para a criacao da Wordlist.\n'\
...
if version_info < (3, 0):
   print(n1+'Error: Progama suportado somente em Python3x.'+u0)
   sleep(2)
   exit()
...
# [2] SEGUNDA DIVISAO../*;
     ...
     print(n4+"Bem-vindo ao Gerador de Lista de palavras."+u0)
     print(n7+"Hawaii I am really sorry. [-] []: [-] [-] [-] []: [-]"+u0)
     print(n4+"Script em Desenvolvimento, Crie sua Wordlist.\n"+u0)
     print(__banner__)
...
# E para tal nao so e preciso de uma boa lista de senhas, mais tambem \;
# de um "script-programa" para forca bruta totalmente funcional. \;
